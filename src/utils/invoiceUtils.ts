...
// High-fidelity Mock Invoices for instant application loading
export const initialMockInvoices: Invoice[] = [
  {
    ...
    supplierGstin: "27AAPCS1030F1Z4", // Maharashtra
    supplierAddress: "Plot No 45, MIDC Industrial Area, Nagpur, Maharashtra, 440028",
    customerName: "Tata Projects Ltd",
    customerGstin: "27AAACT2901G1Z2", // Maharashtra (Intra-state CGST + SGST!)
    customerAddress: "Mithapur Road, Bombay House, Mumbai, Maharashtra, 400001",
    items: [
      {
        id: "item-rod",
        description: "High Tensile TMT Steel Rods (Fe 550D)",
        quantity: 20,
        price: 1500,
        taxRate: 18,
        hsn: "7214",
      ...
      {
        id: "item-beam",
        description: "Heavy Galvanized I-Beams (ISMB 200)",
        quantity: 15,
        price: 2500,
        taxRate: 18,
        hsn: "7216",
    ...
    payments: [
      {
        ...
        referenceNumber: "NEFT20260716991",
        notes: "Full payment received via HDFC corporate bank transfer",
        createdAt: "2026-07-16T10:00:00Z"
      }
    ],
    category: "Sales",
    notes: "Payment received via Bank Transfer on 2026-07-16.",
    createdAt: "2026-07-15T10:00:00Z"
  },
  {
    id: "inv-global-consulting",
    invoiceNumber: "GCG-2026-109",
    date: "2026-07-10",
    supplierName: "Global Consulting Group LLP",
    supplierGstin: "07AAACG8892A1Z5", // Delhi
    supplierAddress: "Tech Park Oasis, Sector 62, New Delhi, 110001",
    customerName: "Reliance Industries Ltd",
    customerGstin: "27AAACR1283D1Z9", // Maharashtra
    customerAddress: "Maker Chambers IV, Nariman Point, Mumbai, Maharashtra, 400021",
    items: [
      {
        id: "item-consult",
        description: "Enterprise Cloud Architecture & Security Audit (Hours)",
        quantity: 12,
        price: 5000,
        taxRate: 18,
        hsn: "9983",
    ...
    payments: [
      {
        ...
        paymentMethod: "UPI",
        referenceNumber: "UPI20260718882",
        notes: "Part payment received. Remaining ₹35,800 due next week.",
        createdAt: "2026-07-18T14:30:00Z"
      }
    ],
    category: "Purchase",
    notes: "Tax Audit Warning: This invoice mistakenly applies local CGST/SGST on an interstate transaction.",
    createdAt: "2026-07-10T14:30:00Z"
  },
  {
    id: "inv-delhi-retailers",
    invoiceNumber: "DL-4402",
    date: "2026-06-28",
    supplierName: "Delhi Retailers Private Limited",
    supplierGstin: "07AABBD3920C1Z0", // Delhi
    supplierAddress: "Block C, Connaught Place, New Delhi, 110001",
    customerName: "John Doe Enterprises",
    customerGstin: "07AAACX1102A1Z0", // Delhi
    customerAddress: "Kamla Nagar, New Delhi, 110007",
    items: [
      {
        id: "item-monitor",
        description: "UltraWide LED Monitors 4K (27 inch)",
        quantity: 5,
        price: 12000,
        taxRate: 28,
        hsn: "8471",
      ...
      {
        id: "item-hubs",
        description: "USB-C Multi-port Hubs (10-in-1)",
        quantity: 10,
        price: 1000,
        taxRate: 18,
        hsn: "8473",
    ...
    payments: [],
    category: "Expense",
    notes: "Math Audit Warning: This invoice has serious tax and total sum calculation errors from the supplier.",
